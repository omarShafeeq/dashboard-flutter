    ...
    return Padding(
      ...
      child: Column(
        children: [
                ...
                lineTouchData: LineTouchData(
                  touchTooltipData: LineTouchTooltipData(
                    ...
                    getTooltipItems: (touchedSpots) {
                      if (_hoveredIndex != null && _hoveredValue != null) {
                        return [
                          LineTooltipItem(
                  ...
                  touchCallback: (event, response) {
                    if (event.isInterestedForInteractions) {
                      ...
                      final chartWidth =
                          context.size!.width - 32; // Subtracting padding
                      final index = (touchX /
                              (chartWidth / (_buildRevenueData().length - 1)))
          ...
          // _hoveredIndex != null
          //     ? Text(
          //         'You are hovering over Day ${_hoveredIndex! + 1}\nRevenue: \$${_hoveredValue!.toStringAsFixed(2)}',
          //         style:
